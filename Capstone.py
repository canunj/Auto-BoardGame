...
Tgen = Title_Generator('C:\\Users\\Taylor School\\Downloads\\base_t5_v2\\base_t5_v2', slim_df)
...
title = 'Tabletop Game Title and Description Generator'
main_text = "HEY YOU! YES! YOU! What are you waiting for, check me out.\nI am here to provide you a description and title to your crazy tabletop game ideas! Want to slay the black dragon while pretneding to be an astronaut? Cool, that's not weird totally not something I might generate for you.\nHow do you use me? SIMPLE! Below there are four types of information to input into me; family, game, mechanics, and category.\nAddiontally if you are looking to lose together there is a toggle to tell me the game you are brewing up is cooperative! But back to the types.\nGame type describes x.Mechanics describes x. Family describes x. Category desribes x.\nNeed a more guided walkthrough or want to see how I perform on a known game, press the lifepreserver button in the top left corner!" 
...
while True:
    ...
    if  event == 'Run':
        if input  == revert_cats(game_v, mech_v, cat_v, family_v, coop):
            ...
            _,_,_,ks = iman.input_parser(iman.set_input(input))
